...
Для завантаження самої системи ubuntu треба перейти на офіційний [сайт](https://ubuntu.com/download/server) та завантажити останню LTS версію Ubuntu server.
